module Ant
  class EmptyComponent < ViewComponent::Base
    def initialize(description: "No Data", image: :default, **html_options)
      @description = description
      @image = image # :default, :simple, or custom image URL
    ...
    def empty_image
      ...
      when :default
        ...
        # Custom image URL
        "<img src=\"#{@image}\" alt=\"Empty\" class=\"w-64 h-40 object-contain\">".html_safe
      end
    end

    def default_empty_svg
      <<~SVG.html_safe
        <svg class="w-64 h-40" viewBox="0 0 184 152" xmlns="http://www.w3.org/2000/svg">
    ...
    def simple_empty_svg
      <<~SVG.html_safe
        <svg class="w-48 h-32" viewBox="0 0 64 41" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(0 1)" fill="none" fill-rule="evenodd">
            <ellipse fill="#f5f5f5" cx="32" cy="33" rx="32" ry="7"/>
            <g fill-rule="nonzero" stroke="#d9d9d9">
              <path d="M55 12.76L44.854 1.258C44.367.474 43.656 0 42.907 0H21.093c-.749 0-1.460.474-1.947 1.257L9 12.761V22h46v-9.24z"/>
